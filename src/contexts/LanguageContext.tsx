...
const DICTIONARY: Record<string, string> = {
  ...
  'Led by Sec. Ms. Farzana Mamtaz. Oversees generation, transmission, and distribution entities.': 'Led by Sec. Ms. Farzana Mamtaz. Oversees generation, transmission, and distribution entities.',
  'Bidyut Bhaban, Abdul Gani Road, Dhaka 1000': 'Bidyut Bhaban, Abdul Gani Road, Dhaka 1000',
  'Led by Sec. Mr. Mohammad Saiful Islam. Manages exploration, extraction, processing of fuels.': 'Led by Sec. Mr. Mohammad Saiful Islam. Manages exploration, extraction, processing of fuels.',
  ...
  'TCB Bhaban, Karwan Bazar, Dhaka 1215': 'TCB Bhaban, Karwan Bazar, Dhaka 1215',
  'Power Cell': 'পাওয়ার Cell',
  'Technical oversight and policy research.': 'Technical oversight and policy research.',
  'Bidyut Bhaban, Abdul Gani Road, Dhaka': 'Bidyut Bhaban, Abdul Gani Road, Dhaka',
  'R&D': 'R&D',
  'Office of Chief Electric Inspector': 'Office of Chief Electric Inspector',
  'Electric inspection.': 'Electric inspection.',
  '25, New Eskaton Road, Dhaka': '25, New Eskaton Road, Dhaka',
  'Energy & Power Research Council': 'এনার্জি & পাওয়ার Research Council',
  'Energy and power research.': 'এনার্জি and power research.',
  'Bidyut Bhaban, Dhaka': 'Bidyut Bhaban, Dhaka',
  'SREDA': 'SREDA',
  'Promotes renewable energy transitions.': 'Promotes renewable energy transitions.',
  'IEB Bhaban, Ramna, Dhaka': 'IEB Bhaban, Ramna, Dhaka',
  'Geological Survey of Bangladesh': 'Geological Survey of Bangladesh',
  'Geological exploration.': 'Geological exploration.',
  '153 Pioneer Road, Segunbagicha, Dhaka': '153 Pioneer Road, Segunbagicha, Dhaka',
  'Technical': 'Technical',
  'Department of Explosives': 'Department of Explosives',
  'Explosives management.': 'Explosives management.',
  'Segunbagicha, Dhaka': 'Segunbagicha, Dhaka',
  'Bureau of Mineral Development': 'Bureau of Mineral Development',
  'Mineral development.': 'Mineral development.',
  'Hydrocarbon Unit': 'Hydrocarbon Unit',
  'Hydrocarbon research.': 'Hydrocarbon research.',
  'Petrocentre, Karwan Bazar, Dhaka': 'Petrocentre, Karwan Bazar, Dhaka',
  'Bangladesh Petroleum Institute': 'Bangladesh Petroleum Institute',
  'Petroleum training.': 'Petroleum training.',
  'Sector 8, Uttara, Dhaka': 'Sector 8, Uttara, Dhaka',
  'BPDB': 'BPDB',
  'Central pillar of generation. Incurs catastrophic operating losses of BDT 39,590 crore, relying on subsidies.': 'Central pillar of generation. Incurs catastrophic operating losses of BDT 39,590 crore, relying on subsidies.',
  'WAPDA Building, Motijheel C/A, Dhaka 1000': 'WAPDA Building, Motijheel C/A, Dhaka 1000',
  'Major urban and regional zones (Chattogram, Cumilla, Mymensingh, Sylhet)': 'Major urban and regional zones (Chattogram, Cumilla, Mymensingh, Sylhet)',
  'Single Buyer': 'Single Buyer',
  'NWPGCL': 'NWPGCL',
  'State-owned combined cycle and LNG plants.': 'State-owned combined cycle and LNG plants.',
  'UTC Building, Panthapath, Dhaka': 'UTC Building, Panthapath, Dhaka',
  'Northwestern Region (Sirajganj, Bheramara)': 'Northwestern Region (Sirajganj, Bheramara)',
  'APSCL': 'APSCL',
  'Ashuganj gas-based power station complex.': 'Ashuganj gas-based power station complex.',
  'Ashuganj, Brahmanbaria': 'Ashuganj, Brahmanbaria',
  'Ashuganj': 'Ashuganj',
  'Focusing on Siddhirganj and Haripur.': 'Focusing on Siddhirganj and Haripur.',
  'Unique Trade Centre, Panthapath, Dhaka': 'Unique Trade Centre, Panthapath, Dhaka',
  'Siddhirganj and Haripur': 'Siddhirganj and Haripur',
  'Matarbari Power Plant': 'Matarbari পাওয়ার প্ল্যান্ট',
  'Ultra Super Critical Coal-Fired. Cheaper baseload power.': 'Ultra Super Critical Coal-Fired. Cheaper baseload power.',
  'Matarbari, Moheshkhali, Cox\'s Bazar': 'Matarbari, Moheshkhali, Cox\'s Bazar',
  'Matarbari': 'Matarbari',
  ...
  'Payra, Patuakhali': 'Payra, Patuakhali',
  'Payra': 'Payra',
  'Rampal Power Plant': 'Rampal পাওয়ার প্ল্যান্ট',
  'Bangladesh-India JV coal plant.': 'Bangladesh-India JV coal plant.',
  'Rampal, Bagerhat': 'Rampal, Bagerhat',
  'Rampal': 'Rampal',
  'Rooppur Nuclear Plant': 'Rooppur Nuclear প্ল্যান্ট',
  ...
  'Rooppur, Ishwardi, Pabna': 'Rooppur, Ishwardi, Pabna',
  'Rooppur': 'Rooppur',
  'Nuclear': 'Nuclear',
  'Summit Group': 'Summit Group',
  'Dominant conglomerate. Received massive capacity charges.': 'Dominant conglomerate. Received massive capacity charges.',
  'Summit Centre, Kawran Bazar, Dhaka': 'Summit Centre, Kawran Bazar, Dhaka',
  'Meghnaghat, Bibiana, Madangonj, Khulna': 'Meghnaghat, Bibiana, Madangonj, Khulna',
  ...
  'United House, Madani Avenue, Dhaka': 'United House, Madani Avenue, Dhaka',
  'EPZs and National Grid': 'EPZs and National Grid',
  'Orion Group': 'Orion Group',
  'Orion House, Tejgaon I/A, Dhaka': 'Orion House, Tejgaon I/A, Dhaka',
  'National Grid': 'National Grid',
  'S. Alam Group': 'S. Alam Group',
  'JV with SEPCO3 for Banshkhali coal plant.': 'JV with SEPCO3 for Banshkhali coal plant.',
  'S. Alam Bhaban, Asadganj, Chattogram': 'S. Alam Bhaban, Asadganj, Chattogram',
  'Banshkhali': 'Banshkhali',
  'Meghna Power Ltd': 'Meghna পাওয়ার Ltd',
  'Top recipient of IPP capacity charges.': 'Top recipient of IPP capacity charges.',
  'Meghnaghat, Narayanganj': 'Meghnaghat, Narayanganj',
  'Meghnaghat': 'Meghnaghat',
  'Rural Power Co. Ltd': 'Rural পাওয়ার Co. Ltd',
  'State-owned acting as IPP, extracting heavy charges.': 'State-owned acting as IPP, extracting heavy charges.',
  'House 19, Sector 1, Uttara, Dhaka': 'House 19, Sector 1, Uttara, Dhaka',
  'Mymensingh, Gazipur': 'Mymensingh, Gazipur',
  'State IPP': 'State IPP',
  'Sembcorp NWPC Ltd': 'Sembcorp NWPC Ltd',
  'Sirajganj': 'Sirajganj',
  'APR Energy': 'APR এনার্জি',
  'Pangaon, Keraniganj': 'Pangaon, Keraniganj',
  'Keraniganj': 'Keraniganj',
  'Haripur Power Ltd': 'Haripur পাওয়ার Ltd',
  'Haripur, Narayanganj': 'Haripur, Narayanganj',
  'Haripur': 'Haripur',
  'United Ashuganj Energy': 'United Ashuganj এনার্জি',
  'Bangla Trac Power Unit-1': 'Bangla Trac পাওয়ার Unit-1',
  'Banani, Dhaka': 'Banani, Dhaka',
  'Adani Godda': 'Adani Godda',
  'Severe dispute over arrears, penalty charges, and inflated coal index.': 'Severe dispute over arrears, penalty charges, and inflated coal index.',
  'Godda, Jharkhand, India': 'Godda, Jharkhand, India',
  'India to Bangladesh': 'India to Bangladesh',
  'Cross-border': 'Cross-border',
  'Bheramara HVDC': 'Bheramara HVDC',
  'India Import.': 'India Import.',
  'Bheramara, Kushtia': 'Bheramara, Kushtia',
  'India Interconnection': 'India Interconnection',
  'Aggreko International': 'Aggreko International',
  'Extracted massive rental payments over 14 years.': 'Extracted massive rental payments over 14 years.',
  'UK Headquartered': 'UK Headquartered',
  'Various short-term sites': 'Various short-term sites',
  'Rental Plant': 'Rental প্ল্যান্ট',
  'Khulna Power Co': 'Khulna পাওয়ার Co',
  'Khulna': 'Khulna',
  'Summit Narayanganj': 'Summit Narayanganj',
  'Narayanganj': 'Narayanganj',
  'Dutch Bangla Power': 'Dutch Bangla পাওয়ার',
  'Acorn Infrastructure': 'অ্যাকর্ন ইনফ্রাস্ট্রাকচার',
  'Chattogram': 'Chattogram',
  'Desh Energy': 'Desh এনার্জি',
  'Siddirganj Max Power': 'Siddirganj Max পাওয়ার',
  'Siddhirganj, Narayanganj': 'Siddhirganj, Narayanganj',
  'Siddhirganj': 'Siddhirganj',
  'Monopolizes domestic gas. Power sector receives only 1050 MMCFD.': 'Monopolizes domestic gas. পাওয়ার sector receives only 1050 MMCFD.',
  'Petrocentre, 3 Kawran Bazar, Dhaka 1215': 'Petrocentre, 3 Kawran Bazar, Dhaka 1215',
  'BAPEX': 'বাপেক্স (বাংলাদেশ পেট্রোলিয়াম এক্সপ্লোরেশন)',
  'Domestic exploration.': 'Domestic exploration.',
  'BAPEX Bhaban, Kawran Bazar, Dhaka': 'BAPEX Bhaban, Kawran Bazar, Dhaka',
  'Domestic Gas Fields': 'Domestic গ্যাস Fields',
  'Gas Production': 'গ্যাস Production',
  'BGFCL': 'BGFCL',
  'Gas fields operation.': 'গ্যাস fields operation.',
  'Birashar, Brahmanbaria': 'Birashar, Brahmanbaria',
  'Brahmanbaria Fields': 'Brahmanbaria Fields',
  'SGFL': 'SGFL',
  'Sylhet gas fields.': 'Sylhet gas fields.',
  'Haripur, Sylhet': 'Haripur, Sylhet',
  'Sylhet Fields': 'Sylhet Fields',
  'GTCL': 'GTCL',
  'High-pressure national transmission.': 'High-pressure national transmission.',
  'GTCL Bhaban, Agargaon, Dhaka': 'GTCL Bhaban, Agargaon, Dhaka',
  'National Transmission Network': 'National Transmission Network',
  'Gas Transmission': 'গ্যাস Transmission',
  'Titas Gas (TGTDPLC)': 'Titas গ্যাস (TGTDPLC)',
  'Dhaka & industrial belts.': 'Dhaka & industrial belts.',
  'Titas Gas Bhaban, Kawran Bazar, Dhaka': 'Titas গ্যাস Bhaban, Kawran Bazar, Dhaka',
  'Greater Dhaka and surrounding industrial belts': 'Greater Dhaka and surrounding industrial belts',
  'Gas Distribution': 'গ্যাস Distribution',
  'Bakhrabad Gas (BGDCL)': 'Bakhrabad গ্যাস (BGDCL)',
  'Cumilla and Noakhali.': 'Cumilla and Noakhali.',
  'Chapapur, Cumilla': 'Chapapur, Cumilla',
  'Cumilla and Noakhali regions': 'Cumilla and Noakhali regions',
  'Karnaphuli Gas (KGDCL)': 'Karnaphuli গ্যাস (KGDCL)',
  'Chattogram region.': 'Chattogram region.',
  'Sholashahar, Chattogram': 'Sholashahar, Chattogram',
  'Chattogram region': 'Chattogram region',
  'Jalalabad Gas (JGTDSL)': 'Jalalabad গ্যাস (JGTDSL)',
  'Sylhet region.': 'Sylhet region.',
  'Gas Bhaban, Mendibagh, Sylhet': 'গ্যাস Bhaban, Mendibagh, Sylhet',
  'Sylhet region': 'Sylhet region',
  'Pashchimanchal Gas': 'Pashchimanchal গ্যাস',
  'Northwestern region.': 'Northwestern region.',
  'Nalka, Sirajganj': 'Nalka, Sirajganj',
  'Northwestern regions': 'Northwestern regions',
  'Sundarban Gas': 'Sundarban গ্যাস',
  'Southwestern region.': 'Southwestern region.',
  'Boyra, Khulna': 'Boyra, Khulna',
  'Southwestern regions': 'Southwestern regions',
  'RPGCL (LNG)': 'RPGCL (LNG)',
  'Manages Moheshkhali FSRUs. Highly exposed to spot market volatility.': 'Manages Moheshkhali FSRUs. Highly exposed to spot market volatility.',
  'RPGCL Head Office, Nikunja-2, Dhaka': 'RPGCL Head Office, Nikunja-2, Dhaka',
  'Moheshkhali Floating LNG Terminals': 'Moheshkhali Floating LNG Terminals',
  'Barapukuria Coal': 'Barapukuria Coal',
  'Monopolized domestic coal mining.': 'Monopolized domestic coal mining.',
  'Barapukuria, Parbatipur, Dinajpur': 'Barapukuria, Parbatipur, Dinajpur',
  'Dinajpur': 'Dinajpur',
  'Coal Mining': 'Coal Mining',
  'BPC': 'BPC',
  'Imports crude oil and refined petroleum.': 'Imports crude oil and refined petroleum.',
  'BSCIC Building, Agrabad, Chattogram': 'BSCIC Building, Agrabad, Chattogram',
  ...
  'National and international gas exploration and production': 'National and international gas exploration and production',
  'Petrocenter, Dhaka': 'Petrocenter, Dhaka',
  'Regional gas distribution utilities': 'Regional gas distribution utilities',
